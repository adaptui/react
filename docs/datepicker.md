...
void</code> | | | **`isDisabled`** | <code>boolean \| undefined</code> | | |
**`isReadOnly`** | <code>boolean \| undefined</code> | | | **`isRequired`** |
<code>boolean \| undefined</code> | | | **`pickerId`** | <code>string \|
undefined</code> | | | **`isDateRangePicker`** | <code>boolean</code> | |
