 ...
 * ```
 */
export declare const useFocusTrap: import("ariakit-utils/types").Hook<FocusTrapOptions<"span">>;
/**
 ...
 * ```
 */
export declare const FocusTrap: import("ariakit-utils/types").Component<FocusTrapOptions<"span">>;
