 ...
 * ```
 */
export declare const useCommand: import("ariakit-utils/types").Hook<CommandOptions<"button">>;
/**
 ...
 * ```
 */
export declare const Command: import("ariakit-utils/types").Component<CommandOptions<"button">>;
