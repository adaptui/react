 ...
 * ```
 */
export declare const useRole: import("ariakit-utils/types").Hook<RoleOptions<"div">>;
/**
 ...
 * ```
 */
export declare const Role: import("ariakit-utils/types").Component<RoleOptions<"div">>;
