 ...
 * ```
 */
export declare const useVisuallyHidden: import("ariakit-utils/types").Hook<VisuallyHiddenOptions<"span">>;
/**
 ...
 * ```
 */
export declare const VisuallyHidden: import("ariakit-utils/types").Component<VisuallyHiddenOptions<"span">>;
