 ...
 * ```
 */
export declare const usePortal: import("ariakit-utils/types").Hook<PortalOptions<"div">>;
/**
 ...
 * ```
 */
export declare const Portal: import("ariakit-utils/types").Component<PortalOptions<"div">>;
