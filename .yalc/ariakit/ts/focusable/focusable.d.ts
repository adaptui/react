 ...
 * ```
 */
export declare const useFocusable: import("ariakit-utils/types").Hook<FocusableOptions<"div">>;
/**
 ...
 * ```
 */
export declare const Focusable: import("ariakit-utils/types").Component<FocusableOptions<"div">>;
