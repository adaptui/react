 ...
 * ```
 */
export declare const useButton: import("ariakit-utils/types").Hook<ButtonOptions<"button">>;
/**
 ...
 * ```
 */
export declare const Button: import("ariakit-utils/types").Component<ButtonOptions<"button">>;
