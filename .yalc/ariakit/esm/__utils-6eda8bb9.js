import { isObject, isInteger } from 'ariakit-utils/misc';
import { createStoreContext } from 'ariakit-utils/store';

const FormContext = createStoreContext();
...
export { FormContext as F, setAll as a, createNames as c, get as g, hasMessages as h, set as s };
