...
import { fireBlurEvent, fireKeyboardEvent, isSelfTarget } from 'ariakit-utils/events';
import { useLiveRef, useSafeLayoutEffect, useEventCallback, useForkRef } from 'ariakit-utils/hooks';
import { useStoreProvider } from 'ariakit-utils/store';
import { createHook, createComponent, createElement } from 'ariakit-utils/system';
import { useFocusable } from '../focusable/focusable.js';
import { f as findEnabledItemById, a as findFirstEnabledItem, C as CompositeContext, g as groupItemsByRows } from '../__utils-7da92179.js';
...
const useComposite = createHook(_ref => {
  let {
    state,
    composite = true,
    focusOnMove = true,
  ...
  const onKeyDown = useCallback(event => {
    ...
    const isGrid = !!((_findFirstEnabledItem = findFirstEnabledItem(state.items)) != null && _findFirstEnabledItem.rowId);
...
const Composite = createComponent(props => {
