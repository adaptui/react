...
const useComboboxDisclosure = system.createHook(_ref => {
  let {
    state,
    ...props
  } = _ref;
...
const ComboboxDisclosure = system.createComponent(props => {
  const htmlProps = useComboboxDisclosure(props);
  return system.createElement("button", htmlProps);
});

exports.ComboboxDisclosure = ComboboxDisclosure;
exports.useComboboxDisclosure = useComboboxDisclosure;
