...
var combobox_comboboxList = require('./combobox-list.js');
...
function isController(target) {
  ...
  if ("id" in target) {
    ...
    return dom.matches(target, selector);
  }
...
const useComboboxPopover = system.createHook(_ref => {
  let {
    state,
    tabIndex,
  ...
  props = combobox_comboboxList.useComboboxList({
    state,
    ...props
  });
...
const ComboboxPopover = system.createComponent(props => {
