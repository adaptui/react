 ...
 */
export declare function createComponent<O extends Options>(render: (props: Props<O>) => JSX.Element | null): Component<O>;
/**
 ...
 * }
 */
export declare function createElement(Type: ElementType, props: HTMLProps<Options>): JSX.Element | null;
/**
