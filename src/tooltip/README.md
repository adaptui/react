...
> These props are returned by the state hook. You can spread them into this
> component (`{...state}`) or pass them separately. You can also provide these
> props from your own state logic.
...
- **`animating`** <code>boolean</code>

  Whether it's animating or not.

- **`stopAnimation`** <code>() =&#62; void</code>
