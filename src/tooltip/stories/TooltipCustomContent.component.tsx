...
export const TooltipCustomContent: React.FC<
    ...
    <div style={{ display: "flex", gap: 20, padding: 100 }} {...props}>
      ...
      <TooltipBasic label="Article">
        <article>
          ...
          qui. Magnam delectus ex totam repellat amet distinctio unde, porro
          architecto voluptatibus nemo et nisi, voluptatem eligendi earum autem
          fugit.
        </article>
      </TooltipBasic>
